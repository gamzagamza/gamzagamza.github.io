...
![img](https://blog.kakaocdn.net/dn/FHZsp/btra4XfP0TV/yZbjH9Y5JycYM9Cc3pKMHk/img.png)
...
![img](https://blog.kakaocdn.net/dn/c2OaWd/btrbbSFnsxz/MqUVeoaN9JM5JhkQz5hrP1/img.png)

 만약 있으면 아래처럼 개행해주어야 합니다.

![img](https://blog.kakaocdn.net/dn/ddk0N6/btrbgkA1OIt/KqJdJ0DFcDCRpzKdijYIBk/img.png)
...
![img](https://blog.kakaocdn.net/dn/9dfvm/btrboeftFje/OSIKfmfWShGn3tigbCqoIk/img.png)

재시작을 시도하니 무슨 에러가 발생했다고 Nginx를 재시작하지 못했다는 내용이 출력이된다. 그리고 journalctl -xe 라는 명령어로 확인해보라고해서 한번 확인해보았습니다.

![img](https://blog.kakaocdn.net/dn/oqbjH/btrbotjs5mS/4oXyoAshh0whHdJmIyNjJK/img.png) 
